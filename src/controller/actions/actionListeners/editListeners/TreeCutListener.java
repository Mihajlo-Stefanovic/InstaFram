...
import controller.commands.editCommands.CutCommand;
import model.tree.MyJTree;
import model.tree.nodes.MyTreeNode;
import model.tree.nodes.MyTreeNodeTypes;

public class TreeCutListener extends MyActionListener {
	...
	protected void myActionPerformed(ActionEvent event) {
		...
		AppCore.getInstance().getCommandManager().addCommand(new CutCommand(selectedNodes));
